...
if __name__ == "__main__":
    ...
    # sample_test(train_dataset, 100, "tmp/plane_box/paralle_train_ext_sample", 4, 64)
    ...
    # lambda y_predict, y_target: -nn.functional.mse_loss(y_predict, y_target)