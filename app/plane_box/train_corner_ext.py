...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.to_container(load_exp_config(
        ...
        "app/plane_box/conf/corner_trainext_vec_env.yaml",
        is_resolve = True
    ))
    ...
    train_dataset = PrEnvRenderDataset(
        CornerEnv, "scene/plane_box/corner_vec4_test2.ttt", train_env_kwargs, num_epoch_data = 51200
    )
    # train_dl = DataLoader(train_dataset, 64, num_workers = 4)

    # test_dataset = PrEnvRenderDataset(
    #     CornerEnv, "scene/plane_box/corner_vec4_test2.ttt", eval_env_kwargs, num_epoch_data = 10240
    # )
