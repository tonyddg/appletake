...
class CornerSubEnv(PlaneBoxSubenvBase):
    ...
    def __init__(
        ...
        super().__init__(
            name_suffix, obs_trans, obs_source, Shape("Plane" + name_suffix), env_action_noise, env_init_box_pos_range, env_init_vis_pos_range,
...
class CornerEnv(PlaneBoxEnv):
    ...
    def __init__(
        ...
        super().__init__(
            env_pr, subenv_mid_name, subenv_range, CornerSubEnv, None, obs_trans, obs_source, 
