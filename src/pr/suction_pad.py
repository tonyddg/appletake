...
class SuctionPad(Shape):
    """
    代码参考自 https://github.com/stepjam/PyRep/blob/master/pyrep/robots/end_effectors/suction_cup.py
    Represents all suction cups.
    """

    def __init__(self, count: int, name: str, base_name: Optional[str] = None):
